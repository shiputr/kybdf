...
function applyLanguage(lang) {
    ...
    const orgNameBn = document.getElementById('orgNameBn');
    const orgNameEn = document.getElementById('orgNameEn');
    if (orgNameBn && orgNameEn) {
        if (lang === 'bn') {
            orgNameBn.style.display = 'block';
            orgNameEn.style.display = 'none';
        } else {
            orgNameBn.style.display = 'none';
            orgNameEn.style.display = 'block';
        }
    }
